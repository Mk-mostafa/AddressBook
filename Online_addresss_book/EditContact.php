...
$query="SELECT * from addressTest where id='$id'";
          ...
          <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="fullname" value="<?php echo $check['FullName'];?>" placeholder="Enter your FullName"/>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" name="nickname" value="<?php echo $check['NickName'];?>"  placeholder="Enter your NickName"/>
                </div>
              </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" name="phone" value="<?php echo $check['PhoneNo'];?>"  placeholder="Enter your phone no"/>
                </div>
              </div>
            </div>
