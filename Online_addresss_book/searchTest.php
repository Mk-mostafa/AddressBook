                   ...
                   <div class="col-sm-12">
                    <?php
                        if(isset($_POST['search']))
                            ...
                            $query="SELECT * FROM addressTest WHERE (FullName LIKE '%$search%' OR NickName LIKE '%$search%' OR Address LIKE '%$search%' OR Email LIKE '%$search%' OR PhoneNo LIKE '%$search%' OR Website LIKE '%$search%' ) AND user_id='$user_id'"; 
